...
-- ============================================================
-- PASSWORD RESET OTPS (Telegram-DM channel)
-- See supabase/migrations/20260509_password_reset_otps.sql for
-- the full rationale. Server-only table; RLS is deny-all because
-- every code path here must use the service-role key.
-- ============================================================
...
-- See migration 20260510_admin_recovery_requests.sql for the
-- full design notes. Used by residents who signed up phone-only
-- and have no email or paired Telegram to fall back on.
-- ============================================================
...
comment on table public.admin_recovery_requests is
    'Server-only queue for admin-mediated password resets. Used when a resident has no working email and no paired Telegram. Admin verifies identity out-of-band and resets via /admin/users.';

-- ============================================================
-- STAFF MANAGEMENT (V1)
-- Mirror of supabase/migrations/20260511_staff_management.sql
-- ============================================================
