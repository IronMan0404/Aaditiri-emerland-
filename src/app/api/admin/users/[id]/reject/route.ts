...
import { rejectRegistration } from '@/lib/decisions/registrations';

// Admin-only: reject a pending registration with a reason.
// Implementation in src/lib/decisions/registrations.ts.
